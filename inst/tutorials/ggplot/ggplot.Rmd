...
ggplot is part of the tidyverse, so to use these functions in your own R session you would need to load that library.  I've pre-loaded it for this tutorial.
