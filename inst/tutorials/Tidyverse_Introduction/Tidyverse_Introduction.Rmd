...
We will use data from a pilot experiment measuring the growth of various wild tomato accessions and species under different light conditions.  To load this data into R you would need to run the code below, modifying the path as appropriate (you do not need to modify it for this tutorial).
