...
starwars.bio.species <- inner_join(starwars.biodata,starwars.species)
...
starwars.bio.species <- left_join(starwars.biodata,starwars.species)
starwars.bio.species
```
...
starwars.bio.species <- full_join(starwars.biodata,starwars.species)
starwars.bio.species
```

## Specifying keys

By default data sets are joined by using all columns that have the same name in the two data sets.  You can specify a particular column by using the `by` argument.  Or, if the columns have different names in the two data sets you can specify the equivalency as shown here:
